...
const char us_q7[] PROGMEM = "Conneticut";
const char us_q8[] PROGMEM = "Dell aware";
const char us_q9[] PROGMEM = "Florida";
const char us_q10[] PROGMEM = "jorge a";
const char us_q11[] PROGMEM = "Ha why ee";
const char us_q12[] PROGMEM = "eye da ho";
const char us_q13[] PROGMEM = "Ill i noy";
const char us_q14[] PROGMEM = "Indeeana";
const char us_q15[] PROGMEM = "I ow wa";
const char us_q16[] PROGMEM = "Kanzas";
const char us_q17[] PROGMEM = "Kentucky";
const char us_q18[] PROGMEM = "Louw ee zee anna";
...
const char us_q34[] PROGMEM = "North Dak o ta";
const char us_q35[] PROGMEM = "Ohio";
const char us_q36[] PROGMEM = "Oklahoma";
const char us_q37[] PROGMEM = "Oreg on";
const char us_q38[] PROGMEM = "Pensil vania";
const char us_q39[] PROGMEM = "Rode Island";
const char us_q40[] PROGMEM = "South Carolina";
const char us_q41[] PROGMEM = "South Dak o ta";
const char us_q42[] PROGMEM = "Tennessee";
const char us_q43[] PROGMEM = "Tex as";
const char us_q44[] PROGMEM = "Utah";
const char us_q45[] PROGMEM = "Ver mont";
...
const char us_q50[] PROGMEM = "Wy oming";
...
const char us_a8[] PROGMEM = "Dowver";
const char us_a9[] PROGMEM = "Talla has ee";
const char us_a10[] PROGMEM = "Atlanta";
const char us_a11[] PROGMEM = "Honolulu";
const char us_a12[] PROGMEM = "Boy zee";
const char us_a13[] PROGMEM = "Springfield";
const char us_a14[] PROGMEM = "Indee an apolis";
const char us_a15[] PROGMEM = "Dee Moin";
const char us_a16[] PROGMEM = "Toe pee kaa";
...
const char us_a22[] PROGMEM = "Lans ing";
...
const char us_a31[] PROGMEM = "Santa Fay";
const char us_a32[] PROGMEM = "Alb any";
